...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By RAMANI",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Ramani*!"""})
...
def setting_bg():
    ...
    <style>
        .stApp {{
            background: linear-gradient(to right, 	#faca2b, 	#faca2b);
